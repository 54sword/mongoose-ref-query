                 ...
                 while (( c_path = rest_of_path.shift() )) {
                     ...
                     if ( rest_of_path.length ) {
                         ...
                         if ( ( isObject(c_expression) ) &&
                             ...
                             projection[ key ] = { $size: c_expression.$size }; // TODO CHANGE TO EXTEND projection[key], update other places too 
...
/*
function setQueryAttribute(expression, path, extension) {
    var pool, has$and = false;
    if ( ! expression[path] ) pool = expression[path] = {};
